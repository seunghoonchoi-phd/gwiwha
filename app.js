...
function startMockExam() {
  ...
  if (cfg.ladder) {
    ...
    const quota = { '한국어': 12, '법': 5, '사회': 5, '역사': 4, '문화': 3, '정치': 3, '경제': 3, '지리': 1 };
    const all = mcOnly();
    const byCat = {};
